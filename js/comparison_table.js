...
(function() {
  var ForComparison, isObject, isString, rotateText, supportsCanvas, testEquality, testRepr, values;
  ...
  */
  ...
  this.buildComparisonTable = function(values, comparator) {
    var $el, $headRow, $table, $tr, comp, comps, evalStr, td, tf, v, valX, valY, _i, _j, _k, _len, _len1, _len2, _ref;
    comps = (function() {
